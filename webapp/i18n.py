...
TRANSLATIONS["en"] = {
    ...
    "academic.schedule_btn": "Upload class schedule",
    "academic.schedule_title": "Upload your class schedule",
    "academic.schedule_note": "Courses you are taking now are added with no grade yet. Enter the grade here once it is posted.",
    "academic.sched_step_open": "Open \u201cStudy List\u201d",
    "academic.sched_step_upload": "Upload that .html file here",
    ...
    "notes.delete_all": "Delete all in this term",
    "notes.confirm_delete_selected": "Delete the selected notes?",
    "notes.confirm_delete_all": "Delete every note in {term}? This cannot be undone.",
    ...
    "flash.schedule_missing": "Please choose your class schedule .html file.",
    "flash.schedule_imported": "Added {count} courses in progress ({terms}).",
...
TRANSLATIONS["ja"] = {
    ...
    "academic.schedule_btn": "履修予定表を取り込む",
    "academic.schedule_title": "履修予定表を取り込む",
    "academic.schedule_note": "いま履修中の科目が成績なしで追加されます。成績が出たらここで入力できます。",
    "academic.sched_step_open": "「Study List」を開く",
    "academic.sched_step_upload": "その .html をここにアップロードする",
    ...
    "notes.delete_all": "この学期のノートを全部削除",
    "notes.confirm_delete_selected": "選択したノートを削除しますか?",
    "notes.confirm_delete_all": "{term} のノートをすべて削除しますか? 元に戻せません。",
    ...
    "flash.schedule_missing": "履修予定表の .html ファイルを選択してください。",
    "flash.schedule_imported": "履修中の科目を {count} 件追加しました({terms})。",
...
TRANSLATIONS["zh"] = {
    ...
    "academic.schedule_btn": "上传课程表",
    "academic.schedule_title": "上传课程表",
    "academic.schedule_note": "当前修读的课程会以“暂无成绩”加入。成绩公布后可在此填写。",
    "academic.sched_step_open": "打开「Study List」",
    "academic.sched_step_upload": "把该 .html 文件上传到这里",
    ...
    "notes.view": "查看",
    "notes.select_all": "全选",
    "notes.delete_selected": "删除所选",
    "notes.delete_all": "删除本学期全部笔记",
    "notes.confirm_delete_selected": "确定要删除所选笔记吗？",
    "notes.confirm_delete_all": "确定要删除 {term} 的全部笔记吗？此操作无法撤销。",
    ...
    "flash.schedule_missing": "请选择课程表的 .html 文件。",
    "flash.schedule_imported": "已添加 {count} 门修读中的课程（{terms}）。",
...
TRANSLATIONS["ko"] = {
    ...
    "academic.schedule_btn": "수강 시간표 올리기",
    "academic.schedule_title": "수강 시간표 가져오기",
    "academic.schedule_note": "지금 수강 중인 과목이 성적 없이 추가됩니다. 성적이 나오면 여기에 입력하세요.",
    "academic.sched_step_open": "「Study List」를 엽니다",
    "academic.sched_step_upload": "그 .html 파일을 여기에 업로드합니다",
    ...
    "notes.delete_selected": "선택 항목 삭제",
    "notes.delete_all": "이번 학기 노트 전체 삭제",
    "notes.confirm_delete_selected": "선택한 노트를 삭제할까요?",
    "notes.confirm_delete_all": "{term}의 노트를 모두 삭제할까요? 되돌릴 수 없습니다.",
    ...
    "flash.schedule_missing": "수강 시간표 .html 파일을 선택하세요.",
    "flash.schedule_imported": "수강 중인 과목 {count}건을 추가했습니다 ({terms}).",
