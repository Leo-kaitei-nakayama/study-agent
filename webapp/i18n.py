...
TRANSLATIONS["en"] = {
    ...
    "notes.col_kind": "Type",
    "assignments.all_courses": "All courses",
    "notes.kind_screenshot": "Page question",
    "nav.ask": "Ask",
    "ask.title": "Ask about a screenshot",
    "ask.subtitle": "Take the shot yourself, then paste or drop it here.",
    "ask.paste_here": "Paste a screenshot",
    "ask.paste_help": "On a Mac press ⌃⌘⇧4 to copy a selection to the clipboard, then press ⌘V anywhere on this page. You can also drag a saved image in.",
    "ask.or_choose": "Or choose a file",
    "ask.what": "What should the agent do?",
    "ask.mode_explanation": "Explain",
    "ask.mode_explanation_help": "what is being asked, and how to think about it",
    "ask.mode_answer": "Draft an answer",
    "ask.mode_answer_help": "a draft for you to review — never submitted",
    "ask.mode_other": "Something else",
    "ask.mode_other_help": "type the instruction below",
    "ask.prompt_label": "Instruction (for “Something else”)",
    "ask.prompt_placeholder": "e.g. summarise this reading in 3 bullets",
    "ask.course_label": "Which course is this for?",
    "ask.no_course": "Not linked to a course",
    "ask.submit": "Ask the agent",
    "ask.answer": "Answer",
    "ask.saved_as_note": "Saved to your notes so you can find it again.",
    "ask.never_submits": "Drafts only — nothing is ever submitted for you.",
    "ask.need_image": "Paste, drop or choose a screenshot first.",
    "ask.need_prompt": "Type what you want the agent to do.",
    "ask.too_big": "That image is too large. Crop it and try again.",
    "ask.bad_type": "Only PNG, JPEG and WebP images are supported.",
    "ask.failed": "Could not read that screenshot. Please try again.",
    "ask.source_upload": "Uploaded by the student",
...
TRANSLATIONS["ja"] = {
    ...
    "notes.col_points": "配点",
    "notes.col_kind": "種類",
    "assignments.all_courses": "すべての科目",
    "notes.kind_screenshot": "画面への質問",
    "nav.ask": "質問",
    "ask.title": "スクリーンショットで質問する",
    "ask.subtitle": "自分で撮って、ここに貼り付けるか落とす。",
    "ask.paste_here": "スクリーンショットを貼り付け",
    "ask.paste_help": "Mac なら ⌃⌘⇧4 で選んだ範囲をクリップボードにコピーし、この画面のどこかで ⌘V。保存済みの画像をドラッグしてもよい。",
    "ask.or_choose": "またはファイルを選ぶ",
    "ask.what": "何をしてほしいか",
    "ask.mode_explanation": "説明",
    "ask.mode_explanation_help": "何を問われていて、どう考えるか",
    "ask.mode_answer": "下書きを作る",
    "ask.mode_answer_help": "見直すための下書き。提出はしない",
    "ask.mode_other": "その他",
    "ask.mode_other_help": "下に指示を書く",
    "ask.prompt_label": "指示（「その他」用）",
    "ask.prompt_placeholder": "例: この読み物を 3 行で要約して",
    "ask.course_label": "どの科目のものか",
    "ask.no_course": "科目に紐づけない",
    "ask.submit": "エージェントに聞く",
    "ask.answer": "回答",
    "ask.saved_as_note": "あとで探せるようノートにも保存した。",
    "ask.never_submits": "作るのは下書きだけで、提出は行いません。",
    "ask.need_image": "先にスクリーンショットを貼り付けるか選んでください。",
    "ask.need_prompt": "何をしてほしいか書いてください。",
    "ask.too_big": "画像が大きすぎます。切り取ってからもう一度。",
    "ask.bad_type": "PNG / JPEG / WebP の画像だけ扱えます。",
    "ask.failed": "その画像を読めませんでした。もう一度お試しください。",
    "ask.source_upload": "学生が自分でアップロード",
...
TRANSLATIONS["zh"] = {
    ...
    "notes.col_points": "分值",
    "notes.col_kind": "类型",
    "assignments.all_courses": "全部课程",
    "notes.kind_screenshot": "页面提问",
    "nav.ask": "提问",
    "ask.title": "用截图提问",
    "ask.subtitle": "自己截图，然后粘贴或拖到这里。",
    "ask.paste_here": "粘贴截图",
    "ask.paste_help": "Mac 上按 ⌃⌘⇧4 将选区复制到剪贴板，再在本页任意处按 ⌘V。也可以拖入已保存的图片。",
    "ask.or_choose": "或选择文件",
    "ask.what": "希望做什么？",
    "ask.mode_explanation": "讲解",
    "ask.mode_explanation_help": "题目在问什么，以及怎么想",
    "ask.mode_answer": "起草答案",
    "ask.mode_answer_help": "供你检查的草稿，不会提交",
    "ask.mode_other": "其他",
    "ask.mode_other_help": "在下方写明要求",
    "ask.prompt_label": "要求（用于“其他”）",
    "ask.prompt_placeholder": "例：用 3 条要点总结这篇阅读",
    "ask.course_label": "属于哪门课？",
    "ask.no_course": "不关联课程",
    "ask.submit": "问一下",
    "ask.answer": "回答",
    "ask.saved_as_note": "已存入笔记，方便以后查看。",
    "ask.never_submits": "仅生成草稿，不会替你提交。",
    "ask.need_image": "请先粘贴、拖入或选择截图。",
    "ask.need_prompt": "请写明希望做什么。",
    "ask.too_big": "图片太大，请裁剪后重试。",
    "ask.bad_type": "仅支持 PNG / JPEG / WebP 图片。",
    "ask.failed": "无法读取该截图，请重试。",
    "ask.source_upload": "学生自行上传",
...
TRANSLATIONS["ko"] = {
    ...
    "notes.col_points": "배점",
    "notes.col_kind": "종류",
    "assignments.all_courses": "모든 과목",
    "notes.kind_screenshot": "화면 질문",
    "nav.ask": "질문",
    "ask.title": "스크린샷으로 질문하기",
    "ask.subtitle": "직접 캡처해서 여기에 붙여넣거나 끌어놓으세요.",
    "ask.paste_here": "스크린샷 붙여넣기",
    "ask.paste_help": "Mac에서 ⌃⌘⇧4로 선택 영역을 클립보드에 복사한 뒤, 이 페이지 어디서든 ⌘V. 저장된 이미지를 끌어다 놓아도 됩니다.",
    "ask.or_choose": "또는 파일 선택",
    "ask.what": "무엇을 해드릴까요?",
    "ask.mode_explanation": "설명",
    "ask.mode_explanation_help": "무엇을 묻고 있고 어떻게 생각할지",
    "ask.mode_answer": "초안 작성",
    "ask.mode_answer_help": "검토용 초안 — 제출하지 않음",
    "ask.mode_other": "기타",
    "ask.mode_other_help": "아래에 지시를 적어주세요",
    "ask.prompt_label": "지시(‘기타’용)",
    "ask.prompt_placeholder": "예: 이 자료를 3줄로 요약해줘",
    "ask.course_label": "어느 과목인가요?",
    "ask.no_course": "과목에 연결하지 않음",
    "ask.submit": "에이전트에게 물어보기",
    "ask.answer": "답변",
    "ask.saved_as_note": "나중에 찾을 수 있도록 노트에도 저장했습니다.",
    "ask.never_submits": "초안만 만들며 대신 제출하지 않습니다.",
    "ask.need_image": "먼저 스크린샷을 붙여넣거나 선택하세요.",
    "ask.need_prompt": "무엇을 할지 적어주세요.",
    "ask.too_big": "이미지가 너무 큽니다. 잘라서 다시 시도하세요.",
    "ask.bad_type": "PNG / JPEG / WebP 이미지만 지원합니다.",
    "ask.failed": "스크린샷을 읽지 못했습니다. 다시 시도해 주세요.",
    "ask.source_upload": "학생이 직접 업로드",
